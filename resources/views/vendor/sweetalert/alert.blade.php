    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.addEventListener('click', function(event) {
            ...
            if (confirmDeleteElement) {
                ...
                var title = confirmDeleteElement.dataset.title || '{{ config('sweetalert.confirm_delete_title', 'Tem certeza?') }}';
                var text = confirmDeleteElement.dataset.text || '{{ config('sweetalert.confirm_delete_text', 'Esta ação não poderá ser desfeita!') }}';
