...
<div class="row">
   ...
   <div class="col-md-4">
      <div class="form-group">
         ...
         <input id="hired_at" name="hired_at" type="date"
            ...
            class="form-control @error('hired_at') is-invalid @enderror" required>
         @error('hired_at')
            <span class="invalid-feedback">{{ $message }}</span>
         @enderror
      </div>
   ...
   <div class="col-md-4">
      <div class="form-group">
         ...
         <input id="vacation_days_per_year" name="vacation_days_per_year" type="number" min="1" max="60"
            value="{{ old('vacation_days_per_year', $employee->vacation_days_per_year ?: 30) }}"
            class="form-control @error('vacation_days_per_year') is-invalid @enderror" required>
