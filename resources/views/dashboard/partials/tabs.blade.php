        ...
        <form id="form-employee">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="employee-days" name="vacation_days_per_year" value="30" min="0" max="60">
                </div>
            </div>
            ...
            <div class="form-grid">
                ...
                <div class="form-group full">
                    ...
                    <textarea id="vacation-coverage" name="coverage_notes" rows="2" placeholder="Quem vai cobrir durante as férias..."></textarea>
                </div>
            </div>
